...
# Create, configure, and manage AWS services e.g. EC2 & S3
# Provides object-oriented API plus low-level access to AWS services 
# 
# 
# 
# STS(Security Token Service - provide temporary security credentials that can control access to  AWS resources
